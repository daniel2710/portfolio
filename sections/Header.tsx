...
const Header = () => {
  return (
      <header id="Home" className="pt-[34px] px-4 bg-main">
        <div>
        ...
        <div className="pt-6 relative">
          <Image priority className="z-50 relative" src={headerImg} alt="header image" />
          <Image priority className="z-10 absolute bottom-[140px] left-5 rotateImg w-20 h-20" src={planet} alt="planet image" />
          <Image priority className="z-[60] absolute bottom-[30px] left-10 w-[120px] h-20" src={dots} alt="dots image" />
          <Image priority className="z-10 absolute bottom-[140px] right-0 w-[120px] h-[120px]" src={outline} alt="outline image" />
        </div>
